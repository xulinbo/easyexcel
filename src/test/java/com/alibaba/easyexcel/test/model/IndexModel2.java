 ...
 * sheet 中间两行
 */
public class IndexModel2 extends BaseRowModel {

    public static int headsize=2;

    @ExcelProperty(value = {"响应报文","字段名Field Nam"},index = 0)
    private String p0;

    @ExcelProperty(value = {"","字段描述Field Desc"},index = 1)
    private String p1;
